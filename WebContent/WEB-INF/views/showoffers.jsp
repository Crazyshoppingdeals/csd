					...
					<div class="widget">
						...
						<ul>
							<li><a href="http://crazyshoppingdeals.in">
								Homepage </a></li>
							<li><a href="http://crazyshoppingdeals.in/#new" onclick="javascript:myClick()" data-toggle="tab" >
								Fresh Offers </a></li>
							<li><a href="http://crazyshoppingdeals.in/#mostclick" onclick="javascript:myClick()" data-toggle="tab" >
								Most Clicked Offers </a></li>
							<li><a href="http://crazyshoppingdeals.in/#popular" onclick="javascript:myClick()" data-toggle="tab" >
