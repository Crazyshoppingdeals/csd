...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" onload="javascript:loadMeFirst();">
	<!-- Navigation -->
		...
		<div class="tab-content responsive mainpage-tab-content">
			...
			<c:forEach items="${maincategories}" var="maincategory">
				...
				<c:forEach items="${maincategory.companies}" var="company">
					<a href="${company.company_name}" onclick="javascript:createCookie('csdcookie','loadOffersByCompanyId('+${company.id_company}+',  '+1+')',2);"> <img
...
(adsbygoogle = window.adsbygoogle || []).push({});
 ...
 -->
					...
					<div style="margin:15px 0px;" align="center">
						<a href="http://tracking.icubeswire.com/aff_c?offer_id=2&aff_id=9514&file_id=52431" target="_blank">
							<img src="http://media.icubeswire.com/brand/files/icubes/2/20151228132512-250x250.jpg" width="250" height="250" border="0" />
						</a>
					</div>
											...
											<c:choose>
												<c:when
													...
													<a href="${offer.tracking_url}" class="btn-coupon"
														...
														onclick="javascript:window.open('${pageContext.request.contextPath}?getCouponCode(${offer.id_offers})','_blank');"
														> <span
...
<div align="center" style="margin:15px 5px;">					
<a href="http://tracking.icubeswire.com/aff_c?offer_id=2&aff_id=9514&file_id=52445" target="_blank"><img src="http://media.icubeswire.com/brand/files/icubes/2/20151228132533-728x90.jpg" width="800" height="110" border="0" /></a>
	</div>			
...
//	    	alert("Text "+searchVal);
	    ...
	    function loadOffersByCompanyId(compid,pageno) {
	    	createCookie('csdcookie','loadOffersByCompanyId('+compid+', '+pageno+')',2);
...
//	    	alert("Text "+searchVal);
	    ...
	    function loadOffersByCategoryId(cateid,pageno) {
	    	createCookie('csdcookie','loadOffersByCategoryId('+cateid+', '+pageno+')',2);
	        $.ajax({
...
//		    	alert("Textbox text : "+searchbox.value);
	    ...
	    function getSearchOffersBtn(pageno) {
	    	createCookie('csdcookie','getSearchOffersBtn('+pageno+')',2);
...
//		    	alert("Textbox text : "+searchbox.value);
	    ...
	    function getSearchOffersByRecentOffers(search) {
	    	createCookie('csdcookie','getSearchOffersByRecentOffers('+search+')',2);
			var searchbox=document.getElementById("SearchBox");
...
//		    	alert("Textbox text : "+searchbox.value);
	    ...
	    function loadSortingOffers(divno, sortorder, pageno) {	    	
	    	createCookie('csdcookie','loadSortingOffers('+divno+', '+sortorder+', '+pageno+')',2);
...
//	    	alert(sortorder);
	    ...
	    function loadMeFirst(){
	    	...
	    	var n = url.indexOf("?getCouponCode(");
	    	var offerid;
	    	
	    	if(n>-1){
	    		
	    		var x = readCookie('csdcookie')
	    		if (x) {
//					eval(x);
	    		...
	    		offerid=url.substring(url.indexOf("(")+1,url.indexOf(")"));
