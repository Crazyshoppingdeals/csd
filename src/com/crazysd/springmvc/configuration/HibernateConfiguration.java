package com.crazysd.springmvc.configuration;
...
@ComponentScan({ "com.crazysd.springmvc.configuration" })
...
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.crazysd.springmvc.model" });
